...
def main():
	...
	parser.add_argument('phonenumber', metavar='p', type=str, help='The phone number you would like to send an sms to.')
	parser.add_argument('message', metavar='m', type=str, nargs='+', help='The message you would like to send.')
	parser.add_argument('-d', '--device_id', help='Overide the default device id, and provide your own.')
	...
	if args.device_id:
		...
		if not result:
			print('Error: Please verify your Device ID')
			print_device_id()
